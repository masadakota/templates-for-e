...
if (document.readyState === "loading") {
  document.addEventListener("DOMContentLoaded", () => {
    const config = window.COPY_HANDLER_CONFIG || {};
    const instance = CopyHandler.createInstance(config);
    instance.initCopyOnRightClick();
    instance.initCopyOnIconClick();
    instance.setCopyIconVisibility(config.showCopyIcon !== false);
